...
ACLOCAL = ${SHELL} /tmp/assignment3/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /tmp/assignment3/missing autoconf
AUTOHEADER = ${SHELL} /tmp/assignment3/missing autoheader
AUTOMAKE = ${SHELL} /tmp/assignment3/missing automake-1.14
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /tmp/assignment3/missing makeinfo
...
STRIP = 
VERSION = 2014-06-12
abs_builddir = /tmp/assignment3
abs_srcdir = /tmp/assignment3
abs_top_builddir = /tmp/assignment3
abs_top_srcdir = /tmp/assignment3
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /tmp/assignment3/install-sh
